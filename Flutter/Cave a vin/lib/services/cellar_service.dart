...
class CellarService extends ChangeNotifier {
  ...
  // Données initiales soignées et variées
  List<WineBottle> _generateInitialBottles() {
    return [
      ...
      WineBottle(
        ...
        appellation: 'Pauillac Grand Cru Classé',
        vintage: 2016,
        wineType: WineType.rouge,
        floor: 4,
        row: BottleRow.fond,
        region: 'Bordeaux',
        optimalYear: 2028,
        notes: 'Grand potentiel de garde, tanins puissants et soyeux.',
      ),
      WineBottle(
        id: _uuid.v4(),
        ...
        region: 'Bordeaux',
        optimalYear: 2026,
        notes: 'Boisé élégant, fruits noirs mûrs.',
      ),
      WineBottle(
        id: _uuid.v4(),
        ...
        region: 'Bourgogne',
        optimalYear: 2027,
        notes: 'Finesse incomparable, cerise noire et sous-bois.',
      ),
      WineBottle(
        id: _uuid.v4(),
        ...
        region: 'Bordeaux',
        optimalYear: 2030,
        notes: 'Bouteille d\'exception pour grande occasion.',
      ),
      ...
      WineBottle(
        ...
        vintage: 2020,
        wineType: WineType.blanc,
        floor: 3,
        row: BottleRow.fond,
        region: 'Bourgogne',
        optimalYear: 2026,
        notes: 'Minéralité saline, notes beurrées et noisette.',
      ),
      WineBottle(
        id: _uuid.v4(),
        ...
        optimalYear: 2025,
        notes: 'Agrumes frais, pierre à fusil.',
      ),
      WineBottle(
        id: _uuid.v4(),
        ...
        region: 'Bordeaux',
        optimalYear: 2026,
        notes: 'Sauvignon rond et gourmand, parfait avec des poissons.',
      ),
      ...
      WineBottle(
        id: _uuid.v4(),
        name: 'Domaine Guigal',
        appellation: 'Côte-Rôtie Brune et Blonde',
        vintage: 2017,
        wineType: WineType.rouge,
        floor: 2,
        row: BottleRow.fond,
        ...
        optimalYear: 2025,
        notes: 'Épices, poivre noir, violette et mûre sauvage.',
      ),
      WineBottle(
        id: _uuid.v4(),
        name: 'Domaine Tempier',
        appellation: 'Bandol Rosé',
        vintage: 2023,
        ...
        region: 'Provence',
        optimalYear: 2025,
        notes: 'Rosé gastronomique, structure ample et pêches de vigne.',
      ),
      WineBottle(
        id: _uuid.v4(),
        name: 'Château Minuty - 281',
        ...
        region: 'Provence',
        optimalYear: 2024,
        notes: 'Très frais, iodé, idéal apéritif d\'été.',
      ),
      ...
      WineBottle(
        ...
        appellation: 'Blanc de Blancs Brut',
        vintage: null,
        wineType: WineType.petillant,
        floor: 1,
        row: BottleRow.fond,
        region: 'Champagne',
        optimalYear: 2026,
        notes: 'Bulles d\'une grande finesse, arômes de brioche et mirabelle.',
      ),
      WineBottle(
        id: _uuid.v4(),
        name: 'Champagne Bollinger',
        appellation: 'Special Cuvée',
        vintage: null,
        wineType: WineType.petillant,
        floor: 1,
        row: BottleRow.devant,
        region: 'Champagne',
        optimalYear: 2025,
        notes: 'Robe dorée, corps puissant et vineux.',
      ),
      WineBottle(
        id: _uuid.v4(),
        name: 'Champagne Dom Pérignon',
        appellation: 'Millésimé Vintage',
        vintage: 2013,
        wineType: WineType.petillant,
        floor: 1,
        row: BottleRow.devant,
        region: 'Champagne',
        optimalYear: 2029,
        notes: 'Cuvée d\'anthologie, toasté et agrumes confits.',
      ),
    ];
  }
}
